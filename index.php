  ...
  <div id="topbar" class="clear"> 
    ...
    <nav>
      <ul>
        ...
        <li><a href="#">Öğretmen Girişi</a></li>
      </ul>
    </nav>
    <!-- ################################################################################################ --> 
  </div>
...
<div class="wrapper row1">
  <header id="header" class="clear"> 
    ...
    <div id="logo" class="fl_left">
      <h1><a href="index.html">Fonksyonlar</a></h1>
      <p>EnesPaçacı</p>
    </div>
    <div class="fl_right">
...
?>
      ...
      <ul id="slide-tabs">
        ...
        <li><a href="#slide-4">uygulama 2</a></li>
        <li><a href="#slide-5">ugulama 3</a></li>
      </ul>
      <!-- ################################################################################################ --> 
    </div>
  </div>
